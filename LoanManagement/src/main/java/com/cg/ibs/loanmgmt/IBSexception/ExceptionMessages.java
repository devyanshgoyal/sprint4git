...
public interface ExceptionMessages {
	...
	public static String MESSAGEFORWRONGINPUT = "Invalid Input.";
	public static String MESSAGEFORINPUTMISMATCH = "Enter only a single-digit numeric.";
	...
	public static String MESSAGEFORINVALIDLOANNUMBER = "Loan number cannot begin with 0 and should be greater than 3 digits";
	public static String MESSAGEFORINPUTMISMATCHATEMI = "Sorry! Please enter an appropriate numeric value.";
	public static String MESSAGEFORSQLEXCEPTION = "Internal error. Try later.";
	public static String MESSAGEFORINVALIDUSERNAME = "User ID allows only lower case input.";
